...
> **[v1.4.0-dev.1](https://github.com/IMXEren/mix-patches/releases/tag/v1.4.0-dev.1)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;2 patches total
<details open>
...
Click here to add these patches to Morphe: https://morphe.software/add-source?github=IMXEren/mix-patches

Or manually add this repository url as a patch source in Morphe: https://github.com/IMXEren/mix-patches
